...
import { cellKey, RANKS, type BoardCard, type RankIndex } from '../../types/poker'
import {
  applyThreshold,
  handEquities,
  type CallingCell,
...
/** Call, fold, or fold-without-the-bounty — the three states a cell can be in. */
type CellShade = 'call' | 'bounty' | 'fold'
